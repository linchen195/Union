...
@property (nonatomic,strong) LoginTextField *nicknameTf;
...
-(void)createTextField{
    // 昵称
    _nicknameTf = [[LoginTextField alloc]initWithFrame:CGRectMake(15, 109, kScreenWidth-30, 50) withLeftViewSize:CGSizeMake(15, 15) withIconImage:[UIImage imageNamed:@"icon_log_nickname"] isBorder:YES];
    _nicknameTf.placeholder = @"请输入你的昵称";
    _nicknameTf.delegate = self;
    [self.view addSubview:_nicknameTf];
    
    // 手机号 和 获取验证码按钮
    UIView *phoneView = [[UIView alloc]initWithFrame:CGRectMake(15, CGRectGetMaxY(_nicknameTf.frame)-1, kScreenWidth-30, 50)];
    ...
    // 注册按钮
    _registerBtn = [[UIButton alloc]initWithFrame:CGRectMake(15, CGRectGetMaxY(_passwordTf.frame)+30, kScreenWidth-30, 49)];
    [_registerBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [_registerBtn setTitle:@"同意服务条款并注册" forState:UIControlStateNormal];
    [_registerBtn setBackgroundImage:[UIImage imageNamed:@"img_btn_background"] forState:UIControlStateNormal];
